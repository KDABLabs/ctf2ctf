...
CliOptions parseCliOptions(int argc, char** argv)
{
    ...
    args::ValueFlagList<std::string> processWhitelistArg(parser, "process", "Only show events for this process", {"process-whitelist"});
    ...
    return {path, args::get(excludeArg), args::get(pidWhitelistArg),
            args::get(processWhitelistArg), args::get(printStatsArg)};
}
